// Method-1 - using recusion and 2d array ( return subsets sum to k)
// #include <bits/stdc++.h>
// using namespace std;
...
// Method-2 - using recusion and 2d array ( print all the subsets sum to k)
#include <bits/stdc++.h>
using namespace std;
int subsetSumToK(int input[], int n, int output[][50], int k)
{
...
{
    int output[50][50];
    size = subsetSumToK(input, size, output, k);
    for (int i = 0; i < size; i++)
    {
        for (int j = 1; j <= output[i][0]; j++)
        {
